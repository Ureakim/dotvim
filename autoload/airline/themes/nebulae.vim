...
function! airline#themes#nebulae#refresh()
	let s:N1 = airline#themes#get_highlight2(['LineNr', 'bg'], ['LineNr', 'fg'], 'none')
	let s:N2 = airline#themes#get_highlight2(['LineNr', 'bg'], ['LineNr', 'fg'], 'none')
	let s:N3 = airline#themes#get_highlight2(['LineNr', 'fg'], ['LineNr', 'bg'], 'none')
	...
	let s:I3 = airline#themes#get_highlight2(['LineNr', 'fg'], ['LineNr', 'bg'], 'none')
	...
	let s:R3 = airline#themes#get_highlight2(['LineNr', 'fg'], ['LineNr', 'bg'], 'none')
	...
	let s:V3 = airline#themes#get_highlight2(['LineNr', 'fg'], ['LineNr', 'bg'], 'none')
	...
	let s:IA3 = airline#themes#get_highlight2(['LineNr', 'fg'], ['LineNr', 'bg'], 'none')
	...
	let g:airline#themes#nebulae#palette.accents = {'black' : airline#themes#get_highlight2(['LineNr', 'bg'], ['ModeMsg', 'fg'], 'none')}
